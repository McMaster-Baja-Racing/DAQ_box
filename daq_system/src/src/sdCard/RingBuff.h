...
IT RingBuff<ET, S, IT, BT>::writeIndex()
{
...
template <typename ET, size_t S, typename IT, typename BT>
bool RingBuff<ET, S, IT, BT>::push(const ET inElement)
{
...
template <typename ET, size_t S, typename IT, typename BT>
bool RingBuff<ET, S, IT, BT>::push(const ET * const inElement)
{
  if (isFull()) return false;
  mBuffer[writeIndex()] = *inElement;
  mSize++;
...
template <typename ET, size_t S, typename IT, typename BT>
bool RingBuff<ET, S, IT, BT>::lockedPush(const ET inElement)
{
  noInterrupts();
...
template <typename ET, size_t S, typename IT, typename BT>
bool RingBuff<ET, S, IT, BT>::lockedPush(const ET * const inElement)
{
  noInterrupts();
  bool result = push(inElement);
  interrupts();
...
template <typename ET, size_t S, typename IT, typename BT>
bool RingBuff<ET, S, IT, BT>::pop(ET &outElement)
{
...
template <typename ET, size_t S, typename IT, typename BT>
bool RingBuff<ET, S, IT, BT>::lockedPop(ET &outElement)
{
  noInterrupts();
...
template <typename ET, size_t S, typename IT, typename BT>
ET &RingBuff<ET, S, IT, BT>::operator[](IT inIndex)
{
